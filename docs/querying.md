...
> **Latency note:** Data becomes queryable ~5 minutes (or 128 MB) after ingestion, once the flush cycle completes and the Iceberg snapshot is committed to the catalog.
