...
> **Latency note:** Data becomes queryable after the pipeline's flush cycle (~10 min ± 2 min, or 32 MB) completes and the Iceberg snapshot is committed to the catalog.
